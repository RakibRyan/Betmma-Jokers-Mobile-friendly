...
do
    ...
    local v_oversupply = SMODS.Voucher{
        ...
        cost=10, unlocked=true,discovered=false, available=true,
    }
    local id='oversupply'
    ...
    local v_oversupply_plus = SMODS.Voucher{
            ...
            cost=10, unlocked=true,discovered=false, available=true, requires={MOD_PREFIX_V..'oversupply'}
    }
...
do 
    ...
    local v_gold_coin = SMODS.Voucher{
        ...
        cost=1, unlocked=true, discovered=false, available=true
    }
    ...
    local v_gold_bar = SMODS.Voucher{
        ...
        cost=1, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'gold_coin'}
    }
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=1,rarity=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'abstract_art'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=5},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'round_up'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'event_horizon'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={""..(G.GAME and G.GAME.probabilities.normal or 1),center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=105},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'target'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=15, unlocked=true, discovered=false, available=true
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=25, unlocked=true, discovered=false, available=true,
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'skip'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}--{center.ability.extra}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=3},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'scrawl'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'reserve_area'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}--{center.ability.extra}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=300},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true,rarity=2
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'overkill'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'3d_boosters'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'b1g50'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'collector'}
    }
    this_v.loc_vars = function(self, info_queue, center)
        if not center then center={ability=this_v.config} end
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'flipped_card'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'prologue'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=8},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'bonus_plus'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'omnicard'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=1},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'cash_clutch'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'eternity'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        if IN_SMOD1 then
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=3},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'debt_burden'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        if IN_SMOD1 then
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=1,rarity=1},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'stow'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=1,rarity=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'undying'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        if IN_SMOD1 then
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=1},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'bargain_aisle'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'gravity_assist'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'garbage_bag'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=2,extra=3},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'echo_wall'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=1,extra=3},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'laminator'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'round_up',MOD_PREFIX_V..'gold_coin'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_overstock_norm',MOD_PREFIX_V..'oversupply'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_directors_cut','v_reroll_surplus'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=3},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_magic_trick','v_blank'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do 
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=4},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_glow_up','v_antimatter'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_planet_merchant',MOD_PREFIX_V..'b1g50'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=1},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_grabber','v_wasteful'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_seed_money',MOD_PREFIX_V..'target'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=1},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_hieroglyph',MOD_PREFIX_V..'abstract_art'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=3},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'collector',MOD_PREFIX_V..'b1g1'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={extra=100},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_petroglyph',MOD_PREFIX_V..'bonus_plus'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'gold_bar',MOD_PREFIX_V..'bonus_plus'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'flipped_card',MOD_PREFIX_V..'omnicard'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_crystal_ball',MOD_PREFIX_V..'omnicard'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'4d_boosters',MOD_PREFIX_V..'oversupply'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={center.ability.extra}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'reserve_area','v_wasteful'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=4},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'collector',MOD_PREFIX_V..'abstract_art'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'eternity',MOD_PREFIX_V..'half_life'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        if IN_SMOD1 then
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=1},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_seed_money',MOD_PREFIX_V..'debt_burden'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=3},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_planet_merchant',MOD_PREFIX_V..'event_horizon'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=3},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'reserve_area',MOD_PREFIX_V..'undying'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=1},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={MOD_PREFIX_V..'oversupply','v_planet_tycoon'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_crystal_ball',MOD_PREFIX_V..'undying'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        if IN_SMOD1 then
...
do
    ...
    local this_v = SMODS.Voucher{
        ...
        config={rarity=2},
        pos={x=0,y=0}, loc_txt=loc_txt,
        cost=10, unlocked=true, discovered=false, available=true, requires={'v_reroll_surplus',MOD_PREFIX_V..'clearance_aisle'}
    }
    handle_atlas(id,this_v)
    this_v.loc_vars = function(self, info_queue, center)
        return {vars={}}
